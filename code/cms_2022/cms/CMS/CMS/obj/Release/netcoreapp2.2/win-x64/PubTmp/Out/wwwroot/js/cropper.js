...
(function (global, factory) {
    ...
    var render$1 = {
        ...
        initCanvas: function initCanvas() {
            ...
            if (naturalWidth >= containerData.width && (naturalHeight / (naturalWidth / containerData.width )) <= containerData.height) {
                canvasWidth = containerData.width;
                canvasHeight = naturalHeight / (naturalWidth / containerData.width);
            } else if (naturalHeight >= containerData.height) {
                canvasHeight = containerData.height;
                canvasWidth = naturalWidth / (naturalHeight / containerData.height);
            } else {
